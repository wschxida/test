...
# (nohup python3 run_sw_search_latest.py > /dev/nul &)  # >/dev/nul,root重定向才进入ES
# D:\App\Python36\python.exe run_sw_search_latest.py
...
def main():
    cmd = 'scrapy_test crawl swsearch -a my_para="latest"'

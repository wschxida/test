...
# (nohup python3 run_sw_search_all.py > /dev/nul &)  # >/dev/nul,root重定向才进入ES
# D:\App\Python36\python.exe run_sw_search_all.py

# tasklist /v /fi "imagename ne pycharm64.exe" |find "run_sw_search_all.py"
...
def main():
    cmd = 'scrapy_test crawl swsearch -a my_para="all"'

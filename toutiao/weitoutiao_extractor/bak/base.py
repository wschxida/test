...
class NewToutiao():
    ...
    def get_signature(self,url):
        signature = os.popen(r'E:\node-v12.16.2-win-x64\node E:\node-v12.16.2-win-x64\get_sign.js {url}'.format(url='"'+url+'"')).read()
    ...
    def get_data(self):
        ...
        base_url += path
        base_url = 'https://www.toutiao.com/api/search/content/?aid=24&app_name=web_search&offset=80&format=json&keyword=123&autoload=true&count=20&en_qc=1&cur_tab=1&from=search_tab&pd=synthesis&timestamp=1615375185187'
